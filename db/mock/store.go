...
import (
	...
	sqlc "github.com/flexGURU/simplebank/db/sqlc"
...
func (m *MockStore) TransferTx(ctx context.Context, arg sqlc.TransferTxParams) (sqlc.TransferTxResults, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "TransferTx", ctx, arg)
	ret0, _ := ret[0].(sqlc.TransferTxResults)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
