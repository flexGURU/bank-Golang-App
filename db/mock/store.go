...
// Source: github.com/flexGURU/simplebank/db/sqlc (interfaces: Store)
...
func (m *MockStore) GetUsers(arg0 context.Context) ([]db.GetUsersRow, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateUserVerification(arg0 context.Context, arg1 string) (db.User, error) {
	m.ctrl.T.Helper()
...
func (mr *MockStoreMockRecorder) UpdateUserVerification(arg0, arg1 interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateUserVerification", reflect.TypeOf((*MockStore)(nil).UpdateUserVerification), arg0, arg1)
}
